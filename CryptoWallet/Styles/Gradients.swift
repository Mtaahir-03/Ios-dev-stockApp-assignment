...
struct Gradients {
    static let strokeGradient = LinearGradient(gradient: Gradient(
        colors: [
    ...
    static let fillGradient = LinearGradient(gradient: Gradient(
        colors: [
    ...
    static let imageGradient = LinearGradient(gradient: Gradient(
        colors: [
